...
public class MadLibsTemplates extends AppCompatActivity {
    ...
    private ArrayList<String> template1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                createTemplate(template1, oneNoun, twoNoun, oneAdjective, twoAdjective, oneVerb, twoVerb);
    ...
    public void createTemplate(ArrayList<String> template, String firstNoun,
